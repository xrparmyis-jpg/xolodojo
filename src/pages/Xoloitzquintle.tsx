          ...
          <div className="max-w-4xl mx-auto [&_p]:text-[#decee9] [&_ul]:text-[#decee9] [&_li]:text-[#decee9] [&_li>span]:text-[#decee9]">
            ...
            <div className="space-y-6">
              ...
              <GsapPageContent as="p" className="mb-4" delay={0.04}>
                ...
                shell while I pull off the impossible."
              </GsapPageContent>
              ...
              <GsapPageContent as="p" className="mb-4" delay={0.08}>
                ...
                twist—he needs the sacred bones from the previous eras, stashed
                deep in Mictlan, the shadowy, nine-level underworld ruled by the
                skeletal party-pooper Mictlantecuhtli (the Lord of the Dead) and
                his queen Mictecacihuatl.
              </GsapPageContent>
              ...
              <GsapPageContent as="p" className="mb-4" delay={0.24}>
                They descend into Mictlan's nightmare levels: rivers of blood,
                screaming winds, mountains of obsidian knives, jaguars that
                don't play fetch. Mictlantecuhtli isn't handing over the goods
                without a fight. He sets impossible trials—like blowing a conch
                shell with no holes. Xolotl, being the ultimate degen trickster,
                summons worms to drill openings. Boom—impossible becomes "done."
                They grab the bones and bolt, with the skeletal hordes chasing
                them like bad exes.
              </GsapPageContent>

              <GsapPageContent as="p" className="mb-4" delay={0.32}>
                In the getaway chaos, Quetzalcoatl trips (because even gods have
                off days), and some bones shatter. That's why humans come in
                every shape, size, and weird quirk—thanks, cosmic clumsiness!
              </GsapPageContent>

              <GsapPageContent as="p" className="mb-4" delay={0.4}>
                Back topside, Quetzalcoatl mixes the bones with his own divine
                blood, breathing life into the current era. But Xolotl's gig
