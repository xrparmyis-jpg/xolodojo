        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            ...
            <GsapPageContent as="section" className="mb-10" delay={0.12}>
              ...
              <p>
                Commercial use (merchandise, advertising, derivative works for
                profit) requires explicit written permission from the project
                team. We retain all copyright and intellectual property rights
                in the underlying artwork except for the limited license granted
                above.
              </p>
            </GsapPageContent>
            ...
            <GsapPageContent as="section" className="mb-10" delay={0.18}>
              <h2 className="mb-4 text-2xl font-semibold">
                4. No Financial Advice – High Risk
              </h2>
              <p>
                NFTs are digital assets with extreme price volatility. Their
                value may go to zero. We make no representations or warranties
                about future value, liquidity, or market performance.
                Participation is at your own risk. Cryptocurrency and blockchain
                technologies carry risks including smart contract bugs, hacks,
                regulatory changes, loss of private keys, and total loss of
                funds.
              </p>
            </GsapPageContent>
            ...
            <GsapPageContent as="section" className="mb-10" delay={0.24}>
              <h2 className="mb-4 text-2xl font-semibold">
                5. Minting and Purchases
              </h2>
              <p>
                All sales/mints are final. No refunds except where required by
                applicable law. Minting requires a compatible wallet (e.g.
                Xaman) and sufficient XRP. Gas/network fees are your
                responsibility.
              </p>
            </GsapPageContent>
            ...
            <GsapPageContent as="section" className="mb-10" delay={0.3}>
              ...
              <ul className="list-disc pl-6">
                <li>
                  Using the Site/NFTs for illegal activities, money laundering,
                  or fraud
                </li>
                <li>
                  Attempting to reverse-engineer, hack, or interfere with the
                  Site or XRPL contracts
                </li>
                <li>
                  Misrepresenting ownership or affiliation with the project
                </li>
              </ul>
            </GsapPageContent>
            ...
            <GsapPageContent as="section" className="mb-10" delay={0.36}>
              ...
              <p>
                THE SITE AND NFTs ARE PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY
                KIND. WE SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
                CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING FROM YOUR USE OF THE
                SITE OR NFTs, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH
                DAMAGES.
              </p>
            </GsapPageContent>
            ...
            <GsapPageContent as="section" className="mb-10" delay={0.42}>
              ...
              <p>
                ...
                e.g. Singapore / State of Delaware / etc.], without regard to
                conflict of law principles. Any disputes shall be resolved
                through binding arbitration [or courts of X jurisdiction].
              </p>
            </GsapPageContent>
            ...
            <GsapPageContent as="section" className="mb-10" delay={0.48}>
              ...
              <p>
                ...
                Site/NFTs after changes constitutes acceptance.
              </p>
            </GsapPageContent>
            ...
            <GsapPageContent as="section" className="mb-10" delay={0.54}>
              ...
              <p>
                ...
                [Twitter/Discord/email — add your actual contact].
              </p>
            </GsapPageContent>
          </div>
        </div>
